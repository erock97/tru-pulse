...
export function prepare(receipt,account,action,approvalReference){
 ...
 if(action==='release'&&receipt.coverageState==='unknown')fail('launch_policy_known_coverage_required');
...
export async function execute(bytes,approvedDigest,approvalReference,token,deps){
 ...
 if(command.action==='release'&&before.coverageState==='unknown')fail('launch_policy_known_coverage_required');
