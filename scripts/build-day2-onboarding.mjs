...
const data={day:2,title:'Winning the first conversation',version:'2026-09-14-alms-onboarding-v1',duration:slides.reduce((n,s)=>n+s.time,0),slides,hero:'',resources:'day2-resources.html',cases:[{name:'Jordan · a garden',quote:'I’d like to see 1234 Lane Saturday morning. I want room for a vegetable garden.',goal:'Buyer reveals the garden reason only after a relevant question. Agent confirms what still needs checking.'},{name:'Maya · text first',quote:'I’m at work. Please text me now; I can talk at five.',goal:'Honor the current preference, acknowledge the request, and agree the later conversation.'},{name:'Alex · questions first',quote:'I only wanted to know about the roof. I’m not ready to book a showing.',goal:'Help with the question, learn context with permission, and respect a declined invitation.'}]};
