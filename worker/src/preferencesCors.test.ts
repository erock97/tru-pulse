...
describe('preference browser preflight',()=>{
 it('allows PUT from the actual app origin',async()=>{
  const request=new Request('https://api.truhq.co/data/preferences',{method:'OPTIONS',headers:{Origin:'https://app.truhq.co','Access-Control-Request-Method':'PUT','Access-Control-Request-Headers':'content-type'}});
