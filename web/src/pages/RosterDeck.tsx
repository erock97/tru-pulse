  ...
  const frame = (body: React.ReactNode) => (
    <div className="tru-dark pulse-refined">
      <HqShell
        ...
        hideTopbar
        islandSlot={mode === 'speed' ? <ContactSpeedPanel orgId={orgId}/> : mode === 'hustle' ? undefined : windowTabs}
