...
describe('live short-answer continuation',()=>{
 ...
 it.each(['day2-objection-practice','day2-channel-check','day3-comparison-discussion','day3-problem-solving-discussion','day3-write-the-follow-up-record'])('submits from the presentation response panel: %s',async slideId=>{
 ...
 it('follows slides with plain-language private notes and rejects non-presenters',async()=>{
  ...
  expect(container.textContent).toContain(`Slide ${definition.slides.findIndex(s=>s.id==='day2-reference')+1} of ${definition.slides.length}`);
  expect(container.textContent).toContain('Which part would you like to practice again');
  expect(container.textContent).toContain('Move to the next slide');
