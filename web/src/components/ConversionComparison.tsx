  ...
  return <div className="conversion-comparison">
    ...
    <details className={`conversion-trend trend-${tone}`}>
      ...
      {trend.prior?<div className="conversion-before-after">
        ...
        <div><span>Now{through?` · ${through}`:''}</span><b>{contractRateLabel(current.perContract,current.leads)}</b><small>{current.contracts} contracts from {current.leads} leads</small></div>
