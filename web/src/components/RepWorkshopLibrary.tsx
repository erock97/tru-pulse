...
export function RepWorkshopLibrary({ presenter=false }: {presenter?: boolean}) {
  ...
  return <>
    ...
    {open&&<div className="rep-workshop-overlay"><WorkshopLesson day={4} onBack={()=>setOpen(false)} onDone={()=>setOpen(false)} doneLabel="Return to training" preview={presenter}/></div>}
  </>;
}
