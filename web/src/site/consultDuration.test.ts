...
const extraPages = import.meta.glob('./pages/{Home,Services,Apply}.tsx', {
  query: '?raw',
  eager: true,
  import: 'default',
...
describe('public consult CTA duration', () => {
  ...
  it('homepage and services still say 60 when those pages are on this branch', () => {
    // Home, services, and apply all promise a 60-minute consult. Keep them
    // from drifting back to 30.
