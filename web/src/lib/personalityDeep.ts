...
// ── The essays — the 16personalities-register read ──────────────────────
// Two paragraphs per type: who they are inside and how it looks, then one
// facet developed with a turn ("the catch is...") — the register Eric pointed
// at with the INTP example. Authored 2026-08-23, grounded in each type's
// trait evidence above so nothing contradicts the assessment.
export const PERSONAL_ESSAY: Record<string, [string, string]> = {
  'P-Pro-R-D': [
    "People wired this way run on two engines at once: real warmth for people, and a relentless need to win. They pick their people — a handful, rarely more — and those few get a loyalty that borders on fierce. Everyone else gets friendliness; the inner circle gets everything. Once they've set a goal they move with total conviction, and they'd rather make a good decision today than a perfect one next week. Feelings matter to them, but feelings get checked against the facts before anything happens.",
    "The same drive that makes them formidable is the thing to watch. When they lock onto a target the world narrows — they'll push through their own exhaustion and everyone else's hesitation, and they can miss a relationship fraying just outside their tunnel. Disloyalty is the one wound that doesn't close quickly; when someone they've protected goes cold, it lands personally and stays a while. At their best, they're the person you want walking into a hard negotiation on your side: prepared, decided, and completely unwilling to let their people lose.",
  ],
  'P-Pro-R-I': [
    "These are the people who move a room without trying. Their feelings sit close to the surface — enthusiasm, conviction, care — and everyone around them can feel it, which is exactly why people follow them. They don't build wide networks so much as adopt people, one at a time, completely. When they believe in something or someone, the belief is loud, physical, and contagious; hesitation near them tends to melt.",
    "The cost of running on heart is that the heart sets the schedule. Their energy comes in waves — all-in weeks, then stretches where the tank is simply empty — and the steady middle gear is the hardest one for them to find. They decide by feel first and check the math later, if at all. And because they give so much to so few, a letdown from someone close doesn't glance off; it lands square and takes days to shake. When they're full, though, nobody is better at making another person believe something good is possible.",
  ],
  'P-Pro-V-D': [
    "Put them anywhere with people in it and watch: within the hour they know names, stories, and who might need what. Their circle never stops growing, because meeting people isn't work to them — it's fuel. Under the friendliness runs a sharp practical eye; while everyone else is chatting, they're noticing the opportunity in the room, and they'll move on it the same day. Deciding comes easy to them. Waiting is the hard part.",
    "Their restlessness is both the gift and the tax. The next person, the next deal, the next room — the pull of new is constant, and the slow careful middle of things bores them, so threads drop: the contact who needed a second call, the detail that needed a second look. They can also slide into working people like pipeline — warmly, even — and spend in a week the relationship that would have paid for a decade. Pointed at volume, with something guarding the follow-through, they simply outwork the field.",
  ],
  'P-Pro-V-I': [
    "Strangers don't stay strangers around them. There's a current to these people — quick, warm, unguarded — that turns a checkout line into a conversation and a conversation into a friend. They run almost entirely on instinct, and the instinct is good: they read a person in seconds and usually read them right. They move fast because standing still feels like losing.",
    "The catch is that everything depends on the current. When the energy is up they're everywhere, brilliant, unstoppable; when it dips they can vanish — from the pipeline, from the plan, from their own calendar. Structure is the thing they resist and the thing they need: the prep, the paperwork, the unglamorous middle of a commitment is where they leak. Charm covers the gap more often than not — until the day it doesn't. Give them momentum and one simple system to catch what they drop, and they're a force.",
  ],
  'P-Rec-R-D': [
    "There's a reason people bring their problems to them. They're social without being loud, warm without being pushy, and there's a steadiness underneath that makes other people exhale. They don't chase — life comes to them, and they meet it with patience and a level head. Their advice is unhurried and usually right, which is why the people who trust them tend to trust them for decades.",
    "The quiet cost of all that steadiness is drift. Waiting is their comfort zone, so the chances that require reaching — a lead worth chasing, an ask worth making, a level worth pushing for — slide past while they tend what's already theirs. And because they hate breaking the peace, hard truths come out softened, sometimes past the point of being heard at all. They'll never be the loudest producer in the room. They'll be the one still standing, still trusted, still referred, ten years after the loud ones burned out.",
  ],
  'P-Rec-R-I': [
    "Whoever is in front of them gets all of them — not the performance of attention, the real thing. They feel what someone needs before it's said and quietly adjust to meet it, which is why people relax around them, open up, and stay. Their circle is small on purpose: they don't really have acquaintances, just people they've decided to love.",
    "The generosity runs one direction, and that's the problem. They pour out and forget to refill; they say yes past their limits; they carry other people's worries home. Anything systematic runs on feeling — strong weeks when they're full, dropped threads when they're stretched. And a truth that might bruise someone they care about gets softened, delayed, or swallowed whole. They will never process people like inventory. Point that presence at the right few, and it earns a loyalty that can't be bought.",
  ],
  'P-Rec-V-D': [
    "Nothing much rattles them. Theirs is an easy calm that isn't laziness — a settled quality other people borrow in a crisis. The circle is wide and low-maintenance; they're welcome everywhere because they bring no drama and take things as they come. When something goes sideways, they're the one finding the sensible next step while everyone else is still reacting.",
    "But easygoing has a downshift problem. Urgency, pressure, the hard push at the hard moment — none of it comes naturally, and some deals and some people need exactly that. They can coast for years on a network that could produce twice what it does, and let warm things cool simply because chasing feels like wasted motion. The move is never to make them someone else; it's to bolt intention onto the calm. Calm plus deliberate is a formidable combination.",
  ],
  'P-Rec-V-I': [
    "They move through life with open hands. People like them almost immediately — no agenda, no pressure, no act — and their world fills with friendly faces because they collect people the way others collect obligations: effortlessly, without keeping score. What feels right leads; plans follow loosely, if at all.",
    "The looseness that makes them lovely to be around is the same looseness that lets their own goals dissolve. Days go where the current goes, follow-up happens by mood, and structure feels like something being done to them. A dropped thread doesn't nag at them the way it nags at other people — which is peace, and also the leak in the boat. Given structure they'll actually accept — simple and human, not bureaucratic — all that easy connection starts compounding instead of evaporating.",
  ],
  'T-Pro-R-D': [
    "They do their living below the surface. Quiet in a room but never idle, they run on preparation — the homework done, the angles considered, the plan built backward from the goal before anyone else has opened the file. They choose their people slowly and rarely, and the chosen few get a loyalty that never announces itself and never wavers. Others hand them their secrets almost immediately; something about them says the vault is real.",
    "Their silence works against them at exactly the moment it matters most: overload. They don't ask for help — they go quieter, work longer, and carry it alone until something visible slips, and by then it's late. Warmer people can misread the reserve as coldness and drift off needing something they were never shown. Even preparation, their great weapon, has a hair-trigger flaw: one more pass over the plan while the window quietly closes. Trusted, given room, and checked on before they'd ever raise a hand, they build things that outlast everyone.",
  ],
  'T-Pro-R-I': [
    "They build slowly, and for keeps. The same person shows up every day — same standards, same calm, same quiet forward motion — which looks unremarkable in any given week and remarkable across any given year. They recharge alone, trust a small handful of people completely, and carry an accurate gut for character: who's real, who's wasting their time, who's worth the investment.",
    "Their conviction is load-bearing and stubborn in equal measure. Once committed they stay — to people, and also to approaches that stopped working a while ago. Advice mostly bounces off; an instinct that's usually right doesn't listen well to counterevidence. And they'll silently carry weight past the point they should have handed some off, because asking feels like a failure of self-reliance. No one will ever promote them — least of all themselves — but anyone watching closely sees the compounding.",
  ],
  'T-Pro-V-D': [
    "Where other people see tasks, they see systems. Hand them a repeating problem and they won't just solve it — they'll build the machine that solves it every time, then quietly keep improving the machine. They're independent by design: autonomy in, results out. Their decisions hold up under pressure because the numbers were consulted first, and their weeks contain remarkably little wasted motion.",
    "The machine-mind has one blind side, and it's people. Relationships resist being systematized, and a client can feel the moment they've become an input. Logic-first delivery lands flat on anyone who needed to feel something first. They'll also over-build — two days of engineering where one awkward phone call would have done — and they'd usually rather work alone than coordinate, leaving team leverage on the table. Pair the machine with even a little practiced warmth, and the output is unfair.",
  ],
  'T-Pro-V-I': [
    "They were never waiting for permission. Self-directed down to the bone, they find their own way to the goal — no audience needed, no playbook consulted, no manager required. What they have instead is instinct: a feel for people and timing they trust completely, mostly because it keeps being right. Nothing about them is performed, and people can tell.",
    "The instinct is real; so is the swing. With no system underneath it, output rides the wave — sharp months, silent months — and the follow-up, the CRM, the boring connective tissue of a business stays an afterthought. Coaching them head-on fails; structure has to feel like their own idea or it gets quietly ignored. The play is small: one simple system they'd actually keep, wrapped around the instinct. That alone turns the swing into a floor.",
  ],
  'T-Rec-R-D': [
    "They think it all the way through before saying a word — and the word, when it comes, is usually the right one. Precise, private, and immune to hype, they catch the detail everyone else skimmed and offer the honest read no one else will. They promise rarely and deliver completely. The few people they trust, they trust totally, and those people get something rare: counsel that has never once been careless.",
    "Deliberation is their craft and their trap. Windows close while they're on the third pass; bold plays get reasoned out of existence; the deal that needed reaching for goes to whoever reached. The precision can also read as distance — a client who wanted to feel cared for got accuracy instead, and quietly left. Nobody should ask them to become impulsive. The ask is smaller than that: a clock on the deliberating, and one sentence of warmth before the analysis.",
  ],
  'T-Rec-R-I': [
    "In any group, they're the still point. Not shy — selective. They'd trade thirty surface conversations for three real ones without a second thought, and in those three they hear everything: what was said, what was underneath it, and what the other person couldn't quite bring themselves to say. People tell them the truth, early, because it's so obviously safe to.",
    "Their radius is the limit. Deep-but-few keeps volume permanently thin, and putting themselves forward — the promotion, the ask, the close — feels to them like a small betrayal of who they are. Under real stress they don't reach out; they recede, so quietly that the people who would help never get the signal. Conflict drifts unaddressed rather than get faced. But inside that radius they produce the rarest thing in any business: relationships strong enough to run on trust alone.",
  ],
  'T-Rec-V-D': [
    "They watch first. In a new room they're the one at the edge — not anxious, just gathering — and by the time they finally speak they usually understand the situation better than the people who've been talking the whole time. Calm is their resting state; other people's heat doesn't transfer. Their wide circle stays warm on remarkably low effort, because what they offer isn't intensity — it's accuracy.",
    "Watching has a price: the moment to act can pass while they're still confirming the read. The observational distance that makes them clear-eyed can land as coolness on people who wanted to be liked, not just understood, and their connections run wide but shallow — few deep enough to refer on their own. When they raise the flag early, while it's still cheap to fix, they're one of the most quietly valuable people in any room. The whole work is speaking sooner.",
  ],
  'T-Rec-V-I': [
    "There's a softness to how they move through the world — unhurried, unforced, genuinely without agenda. Anxious people settle around them. They connect easily with every kind of person precisely because they aren't trying to get anywhere; the moment in front of them is enough. What feels right leads, and they'll flex around whatever the day brings without complaint or panic.",
    "The absence of force is the whole charm and the whole risk. Their own goals dissolve into the current; the ask never quite gets made; the system never quite gets built. Production wanders with mood and season, and left fully alone it settles low. Pushing them hard breaks the exact thing that works. What works is scaffolding — light, external, consistent — that catches what the softness drops, while the softness does what nothing else in the business can: make people feel safe.",
  ],
};
