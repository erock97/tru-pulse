...
// them verbatim from the original at its content high-water mark (commit
// 9dc27df, 2026-06-27). Codes are the same `Energy-Approach-Deal-Decision`
...
export const PERSONAL_DEEP: Record<string, DeepRead> = {
  'P-Pro-R-D': { desc: "A driven, big-hearted leader for a fiercely-protected few — chases what they want and pulls their people along, loyalty backed by a clear, practical head.",
  ...
  'P-Pro-R-I': { desc: "A warm force who chases what matters straight from the heart — a small circle who'd follow them anywhere because they feel how much they care.",
  ...
  'P-Pro-V-D': { desc: "A relentless builder energized by people and opportunity — works a wide, ever-growing network with a sharp eye for the deal others walk past.",
  ...
  'P-Pro-V-I': { desc: "Magnetic, driven, and led by feel — lights up rooms and turns strangers into friends fast, trusting their gut and moving quick.",
  ...
  'P-Rec-R-D': { desc: "The warm, level-headed one people come to — sociable but never pushy, meets what comes with steady judgment, and keeps a small, devoted circle.",
  ...
  'P-Rec-R-I': { desc: "All heart — friendly and present, lets relationships unfold and pours into the few that matter most, so people feel genuinely cared for.",
  ...
  'P-Rec-V-D': { desc: "Friendly with everyone and rattled by no one — takes life as it comes, keeps a wide easy circle, and brings calm, practical sense to all of it.",
  ...
  'P-Rec-V-I': { desc: "Open and unhurried, led by what feels right — knows lots of people, lets things come, and follows their heart wherever it points.",
  ...
  'T-Pro-R-D': { desc: "A patient, behind-the-scenes operator who wins by out-preparing the room and working a long game — reserved, self-directed, and fiercely loyal to a chosen few.",
  ...
  'T-Pro-R-I': { desc: "Builds things that last — quietly, deliberately, from the heart. Recharges alone, goes after what matters, and invests deeply in the people they love.",
  ...
  'T-Pro-V-D': { desc: "Designs their own path and executes it methodically — independent and analytical, would rather build the system and let it run than work the room.",
  ...
  'T-Pro-V-I': { desc: "Does it their own way and from the gut — self-directed and instinctive, never waits for permission or needs a crowd, yet stays loosely connected to many.",
  ...
  'T-Rec-R-D': { desc: "Private, precise, and deeply loyal — takes their time, thinks it all the way through before acting, and the few they trust, they trust completely.",
  ...
  'T-Rec-R-I': { desc: "The calm center their people rely on — would rather have three real conversations than thirty surface ones, trusts what they sense, and refills in quiet.",
  ...
  'T-Rec-V-D': { desc: "Watches before they speak, and sees clearly — comfortable alone, lets life come, and brings a calm, rational eye to a wide but low-maintenance circle.",
  ...
  'T-Rec-V-I': { desc: "Moves through life softly and openly, guided by feeling — does not need the crowd or the chase, lets things unfold, and stays loosely connected to many.",
