...
const ORIGIN_MAIN_DAY1_SLIDES_1_TO_17 = [
  ...
  { n: 5, label: 'People', hash: '465839df:4439' },
  { n: 6, label: 'Demo find the lead', hash: '555340c8:5001' },
  { n: 7, label: 'Four questions', hash: '0b8b51a7:3204' },
  { n: 8, label: 'Details panel', hash: 'a9fd67f2:3385' },
  { n: 9, label: 'Context not story', hash: 'b9682c2f:4195' },
  { n: 10, label: 'Stage truth', hash: '9a160285:7275' },
  { n: 11, label: 'Your turn stages', hash: '133f9152:4304' },
  { n: 12, label: 'The answers', hash: 'dacf7c04:4534' },
  { n: 13, label: 'Notes', hash: '70456032:4801' },
  { n: 14, label: 'Tasks', hash: 'a886828c:4779' },
  { n: 15, label: 'Repair Avery', hash: '96189925:5265' },
  { n: 16, label: 'Four checks', hash: 'b4fdf5b0:4441' },
  { n: 17, label: 'Way back tomorrow', hash: '949e5f78:3240' },
] as const;
